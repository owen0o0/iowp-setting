    ...
    applyRule: function (context, enforced) {
      ...
      if (result) {
        $(controls).each(function () {
          $(this).closest('.iset-field').removeClass('iset-depend-on');
        });
        ...
        $(controls).each(function () {
          $(this).closest('.iset-field').addClass('iset-depend-on');
        });
...
(function($) {
  ...
  function ajaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  ajaxChosen.prototype.init = function() {
  ...
  ajaxChosen.prototype.events = function() {
  ...
  ajaxChosen.prototype.search_field_focused = function() {
  ...
  ajaxChosen.prototype.search_welcome_message = function() {
  ...
  ajaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('iset-chosen', _this.options.data).done( function( response ) {
  ...
  ajaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.iset-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.setSelectionOrder($hidden_value, true);
  ...
  $.fn.ajaxChosen = function(chosenOptions) {
    return this.each(function() {
      new ajaxChosen(this, chosenOptions);
    });
  };
